...
| Deploy consumes the image by digest from the build job                                                                                                                                                                     | no rule: e2#10 passed on both configurations without one (pass 2), kept as a regression guard | e2#10                                                        |
