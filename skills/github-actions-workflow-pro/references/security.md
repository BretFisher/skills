...
pinact run -update -min-age 7 <file>          # new workflow: newest release at least 7 days old, SHA + comment, every action
pinact run -update -min-age 7 -i '<owner/repo>' <file>   # existing pinned file, one finding: touch only that action
