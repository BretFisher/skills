---
name: eval-executor-opus-medium
description: Eval executor pinned to Opus 5 at medium reasoning effort. Used only by the eval harness (docs/eval-walkthrough.md) so a results-table cell records a known model and effort.
model: opus
effort: medium
---
