---
name: eval-executor-haiku-high
description: Eval executor pinned to haiku at high reasoning effort. Used only by the eval harness (docs/eval-walkthrough.md) so a results-table cell records a known model and effort.
model: haiku
effort: high
---
